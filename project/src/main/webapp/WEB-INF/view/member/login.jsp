	    ...
	    <style>
			...
			* {
			...
			main .login-form{
			    ...
			    background: url("../../images/member/bg-login-box.png") no-repeat 0px 0px;
			...
			main .login-btn{
			    width: 83px;
			    height: 53px;
			    background: url("../../images/member/btn-login.png") no-repeat 0px 0px;    
			    overflow: hidden;
	...
	<script type="text/javascript">
		...
		window.onload = function() {
		    ...
		    document.getElementById('btn').onclick = function() {
		    	...
		    	// 비어있지 않다면 submit => action="/memberLogin"
		    	frm.submit();
		    }
		}
	</script>
	                    ...
	                    <form id="frm" class="login-form" method="post">
	                        <fieldset>
	                            ...
	                            <div class="login-btn-box">
	                            	<!-- 로그인 버튼을 눌릴 시 위의 예외처리가 실행됨 -->
	                                <input id="btn" type="button" class="btn login-btn"/>
	                            </div>
	                            <!-- 아이디 찾기는 미구현-->
