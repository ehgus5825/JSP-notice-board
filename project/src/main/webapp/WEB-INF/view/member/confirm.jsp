			...
			<div class="content-container clearfix">
	            ...
	            <main>
	                ...
	                <div class="margin-top first" style="background: url('../images/member/bg-login.png') no-repeat center;height: 277px;">
	                    ...
	                    <div class="text-align-center">
	                    	<!--  회원가입이 완료 되었으니 로그인으로 href="/memberLogin" -->
	                        <a class="btn" style="margin-left:170px; margin-top:50px;display:inline-block;width:83px;height: 53px;background: url('../images/member/btn-login.png') no-repeat center;" href="/memberLogin"></a>
	                    </div>
	                </div>
	            </main>
			</div>
