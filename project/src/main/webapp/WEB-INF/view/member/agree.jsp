	...
	<script type="text/javascript">
		...
		window.onload = function() {
			...
			document.getElementById('submit-button').onclick = function() {
		    	...
		    	// 약관 동의에 체크가 되어있지 않다면 alert 후 return(아무일도 일어나지 않음) 
		    	if(frm.agree.checked == false){
		    		alert("약관에 동의 후 가입할 수 있습니다.");
		    		return;	
		    	}
		    	// 약관 동의에 체크가 되어있다면 submit => action="/memberJoin" 
		    	else{
		    		frm.submit();
		    	}
		    };
	            ...
	            <section>
	                <div class="sub-menu">
	                    <nav id="acount-menu">
	                        ...
	                        <ul>
	                            <li><a href="/noticeList">HOME</a></li>
			...
			<div class="content-container clearfix">
				...
				<main>
					...
					<div class="margin-top first">
						...
						<!-- 약관동의가 예외처리 될 form -->
						<form id="frm" action="/memberJoin" method="post" class="margin-top">
							<div>
								<input type="checkbox" name="agree" value="true" /> 약관에 동의합니다.
							</div>
							<div class="margin-top text-align-center">
								<!-- 다음 버튼을 눌릴 시 위의 예외처리가 실행됨 -->
								<input id="submit-button" class="btn-text btn-default" style="height: 40px; width: 100px; font-size: 13px;" type="button" value="다음" />
							</div>
						</form>
					</div>
				</main>
