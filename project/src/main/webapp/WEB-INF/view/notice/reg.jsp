		...
		window.onload = function() {
		    ...
		    document.getElementById('btn').onclick = function() {
		    	...
		    	if(confirm('글을 정말 등록하시겠습니까?')){
			    	...
			    	// 비어있지 않다면 submit => action="/noticeReg"
					frm.submit();
			    	return;
		        }
		    	// 등록 취소
	            ...
	            <main>
	                ...
	                <form id="frm" method="post" enctype="multipart/form-data">
	                    <div class="margin-top first">
	                        ...
	                        <table class="table">
	                            <tbody>
	                                ...
	                                <tr class="content">
	                                    <td colspan="4"><textarea required class="content" name="content"></textarea></td>
	                                </tr>
	                                <tr>
	                    ...
	                    <div class="margin-top text-align-center">
	                    	<!-- 등록 버튼 클릭시 위의 예외처리가 실행 -->
	                        <input class="btn-text btn-default" id="btn" type="button" value="등록" />
	                        <!-- 취소시 뒤로가기 -->
