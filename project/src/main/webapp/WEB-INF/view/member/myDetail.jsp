			...
			<div class="content-container clearfix">	
				...
				<main>
					...
					<div class="margin-top text-align-center">
						...
						<a class="btn btn-list" href="/memberMyPage?p=${param.p}&f=${param.f}&q=${param.q}">목록</a>
						<!-- 태그 클릭시 memberMyUpdate에 현재 글의 id를 가지고 가서 글을 수정함 -->
						<a class="btn-text btn-default" href="/memberMyUpdate?id=${n.nid}">수정</a>
	                    ...
	                    <script type="text/javascript">
				            ...
				            btn.addEventListener('click', function(){
				            	...
				            	if(confirm('글을 정말 삭제하시겠습니까?')){
					            	...
					            	location.href="/memberMyDelete?id=" + del;
						        }
				            	// 삭제 취소
								else{
									return;
								...
								<tr>
									...
									<c:if test="${nextN.nid != 0}">
										<td colspan="3"  class="text-align-left text-indent">
											...
											<a class="text-blue text-strong" href="/memberMyDetail?p=${param.p}&id=${nextN.nid}&f=${param.f}&q=${param.q}">
												${nextN.title}
											</a>
										</td>
									</c:if>
								...
								<tr>
									...
									<c:if test="${pervN.nid != 0}">
										<td colspan="3"  class="text-align-left text-indent">
											...
											<a class="text-blue text-strong" href="/memberMyDetail?p=${param.p}&id=${pervN.nid}&f=${param.f}&q=${param.q}">
												${pervN.title}
											</a>
										</td>
									</c:if>
